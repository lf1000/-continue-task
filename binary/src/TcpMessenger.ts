...
{
  private port: number = 0; // 0 = OS assigns a random available port
  private host: string = "127.0.0.1";
  private socket: net.Socket | null = null;
  public actualPort: number = 0; // Set after server starts listening
  ...
  constructor() {
    ...
    server.listen(this.port, this.host, () => {
      ...
      console.log(`Server listening on ${this.host}:${this.actualPort} (randomized port)`);
    });
  }
